...
# Soruları, şıkları ve doğru cevapları birbirine bağlı tutmak için bir sözlük listesi (list of dicts) oluşturduk.
# Bu yapı, random ile soruları karıştırırken şıkların ve cevapların kaybolmasını engeller.
quiz_data = [
    {
